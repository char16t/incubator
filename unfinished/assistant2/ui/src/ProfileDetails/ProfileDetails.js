    ...
    return (
      <div className="ProfileDetails">
        ...
        <form className="CommonForm" onSubmit={this.handleSubmit}>
          ...
          <input type="email" name="email" placeholder="Электронная почта" value={email}
          ...
          <input type="submit" value="Обновить личные данные" className="button-primary" disabled={!this.isValid()} />
        </form>
      </div>
    );
  }
