 ...
 * Уровень 2
   - Уровень 2А
     ...
     + 2А: Задачи на квадратичные сортировки
       ...
       * [Сортировка выбором максимума](https://informatics.mccme.ru/moodle/mod/statements/view3.php?chapterid=1411) ([**C++**](https://github.com/char16t/training/blob/master/algoprog.ru/p1411.cpp))
